...
const Card = ({ event, hasOrderLink, hidePrice }: CardProps) => {
    ...
    return (
        <div className="group relative flex min-h-[380px] max-w-[400px] w-full flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
            <Link
            ...
            {isEventCreator && !hidePrice && (
                <div className="absolute right-2 top-2 flex-col flex-between gap-3 rounded-xl bg-white shadow-sm transition-all p-3">
            ...
            <div className="flex min-h-[230px] flex-col gap-3 p-5 md:gap-4">
                ...
                <Link href={`/events/${event._id}`}>
                    <p className="p-medium-16 md:p-medium-20 text-black flex-1 line-clamp-2">{event.title}</p>
                </Link>
